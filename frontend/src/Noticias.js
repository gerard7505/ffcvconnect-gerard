...
const Noticias = () => {
  ...
  const goToStart = () => {
    setCurrentIndex(0); // Vuelve a la primera noticia
  };
  ...
  return (
    <div className="noticias-wrapper">
      ...
      <div className="noticia-captacion">
        ...
        {/* Mostrar "Leer más" solo si showMore es false */}
        {!showMore && (
        ...
        {/* Contenido adicional que se muestra cuando showMore es true */}
        {showMore && (
          <>
            <p>
            ...
            {/* Mostrar "Leer menos" cuando showMore es true */}
            <p className="leer-mas" onClick={handleToggle}>
              Leer menos...
            </p>
          </>
